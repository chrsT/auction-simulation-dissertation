...
class Genome(object):
    def __init__(self, genome_string):
        ...
        #False feedback
        self.genes["false_feedback"] = FalseFeedbackGene(genes_list[4])

        #Personal experience
        self.genes["personal_experience"] = PersonalExperienceGene(genes_list[5])

        #Alturistic Punishment
        self.genes["alturistic_punishment"] = AlturisticPunishmentGene(genes_list[6])
...
class FalseFeedbackGene(Gene):
    def __init(self,value):
        super(FalseFeedbackGene,self).__init__(value)
        self.type = ENUMS.GeneTypeEnum.int
        self.value = int(value)
    ...
    @classmethod
    def mutate(self,val):
        val += RANDOMS.random_int(PARAMETERS.GENETICS_FALSE_FEEDBACK_MUTATE_ADD[0],PARAMETERS.GENETICS_FALSE_FEEDBACK_MUTATE_ADD[1])
...
class PersonalExperienceGene(Gene):
    def __init(self,value):
        super(PersonalExperienceGene,self).__init__(value)
        self.type = ENUMS.GeneTypeEnum.int
        self.value = int(value)
...
class AlturisticPunishmentGene(Gene):
    def __init(self,value):
        super(AlturisticPunishmentGene,self).__init__(value)
        self.type = ENUMS.GeneTypeEnum.int
        self.value = int(value)
